    ...
    <div class="grid">
      ...
      <div class="col-12 md:col-6 xl:col-3 p-3">
        <div class="p-3 text-center bg-purple-500 border-round">
          <span class="inline-flex justify-content-center align-items-center bg-purple-600 border-circle mb-3 p-3"><i class="pi pi-car text-xl text-white"></i></span>
          <div class="text-2xl font-medium text-white mb-2">12</div>
          <span class="text-blue-100 font-medium">Cars</span>
        </div>
      </div>
      <div class="col-12 md:col-6 xl:col-3 p-3">
      ...
      <div class="col-12 md:col-6 xl:col-3 p-3">
        <div class="p-3 text-center bg-cyan-500 border-round">
          ...
          <div class="text-2xl font-medium text-white mb-2">123</div>
