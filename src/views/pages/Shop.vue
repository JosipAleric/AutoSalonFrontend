...
<template>
  ...
  <div
    ...
    style="background-image: url('/demo/images/landing/bugatti.jpg'); background-repeat: no-repeat; background-position: center; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover"
  >
    <div class="md:mt-8 flex justify-content-center mx-6 mt-auto pb-5 fadeindown animation-duration-1000">
      <div class="p-inputgroup" style="max-width: 600px">
        <InputText class="opacity-70 p-inputtext-lg shadow-8" placeholder="Search" />
